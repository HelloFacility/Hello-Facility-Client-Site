...
import CleaningServiceBanner from '../../Images/CleaningBanner.jpg'
                    ...
                    <div className="flex flex-wrap items-center pb-12">
                        <div className="md:w-1/2 lg:w-1/2 mx-auto w-full xl:pr-20 md:pr-6">
                            <div className="py-2 text-color">
                                ...
                                <p className="text-xl xl:text-left md:text-left lg:text-left md:w-full text-center w-full mx-auto xl:mx-0 lg:mx-0 text-gray-600">You made it so simple. My new site is so much faster and easier to work with than my old site. I just choose the page, make the change and click save.</p>
                                <div className="flex items-center cursor-pointer pb-4 md:pb-0">
                                    <h3 className="f-f-r text-lg lg:text-xl font-semibold text-green-700">Learn More</h3>
                                    <div className="pl-2">
                                        <svg className="pt-1" width={20} height={40} viewBox="0 0 45 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                            <img className="absolute w-full h-full inset-0 object-cover object-center rounded-md" src={CarRenralBanner} alt />
                                ...
                                <div className="flex items-center justify-between w-full sm:w-full mb-8">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-6">
                                            ...
                                            <p className="text-gray-600 text-sm tracking-normal font-normal leading-5">Happy Customer</p>
                                        </div>
                                    </div>
                                    <div>
            ...
            <div className="pb-32 pt-16">
                <div className="mx-auto">
                    <div className="flex flex-wrap flex-row-reverse items-center">
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                            <img className="absolute w-full h-full inset-0 object-cover object-center rounded-md" src={CleaningServiceBanner} alt />
                            <div className="relative z-10 p-4 bg-white shadow rounded mx-auto w-9/12 -mb-20">
                                <p className="text-gray-600 text-xs leading-3 font-normal">One stop Cleaning Service</p>
                                <div className="mt-4 flex items-center">
                                    ...
                                    <p className="ml-1 text-sm text-gray-800 leading-3 tracking-normal font-normal">Vacuum Cleaning </p>
                                </div>
                                <div className="mt-3 flex items-center">
                                    ...
                                    <p className="ml-1 text-sm text-gray-800 leading-3 tracking-normal font-normal">2,499 BDT</p>
                                </div>
                                <button className="relative focus:outline-none mt-4 py-2 pr-10 bg-sky-900 text-white tracking-normal text-xs pl-3 cursor-pointer hover:opacity-90">
                                    All Service
