...
import CleaningImg from '../../../Images/CleaningService.png'
...
const CleaningService = () => {
    return (
        <div className="py-6 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-gray-50">
            ...
            <div className="xl:w-2/5 md:w-1/2 w-full pl-20">
                    <div className="w-full">
                        <img src={CleaningImg} alt="Purple flowers on a book" className="md:w-full sm:w-1/2 w-3/4" />
                    </div>
                </div>
                <div className="xl:w-3/5 md:w-1/2 w-full">
                    ...
                    <div className="mt-10">
                        <button className="flex items-center md:p-3 p-1 focus:outline-none text-xl font-medium leading-5 text-gray-800">
                            Learn more
                            <svg className="ml-6" width={45} height={40} viewBox="0 0 45 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
