    ...
    return (
        <div className='text-justify'>
            ...
            <div className='h-96 mt-1' style={{
                ...
                <div className='lg:flex md:justify-between items-center'>
                    <div className='flex gap-4 items-baseline'>
                        <div>
                            <h1 className='lg:text-4xl md:text-3xl text-2xl font-bold mt-16 lg:ml-28 md:ml-16 ml-5 text-white'>Car Rental</h1>
                        </div>
                        <div>
            ...
            <div className='pt-10'>
                ...
                <h1 className='text-center text-3xl font-bold text-sky-900'>Car Rental</h1>
                <div className='lg:mx-20 md:mx-16 mx-5 mt-10 gap-12'>
                    <div>
                        <h2 className='font-semibold text-lg text-sky-900'>Our Offerings as a Car Rental Service</h2>
                        ...
                        <h2 className='font-semibold text-lg text-sky-900 pt-6'>Why Should You Rent a Car in Dhaka?</h2>
                        ...
                        <h2 className='font-semibold text-lg text-sky-900 pt-6'>Low Cost And Affordability</h2>
                        ...
                        <h2 className='font-semibold text-lg text-sky-900 pt-6'>A Lot More Freedom!</h2>
                        ...
                        <h2 className='font-semibold text-lg text-sky-900 pt-6'>Meets Your Need</h2>
            ...
            <div className='lg:mx-20 md:mx-16 mx-5 mt-10 pb-5'>
                <h2 className='font-semibold text-lg text-sky-900 pt-6'>Why Choose The Hello Facility for Rent-a-car in Dhaka?</h2>
