        ...
        <div className='text-justify'>
            <div>
                ...
                <div className='pt-10'>
                    ...
                    <h1 className='text-center text-3xl font-bold text-sky-900'>Building Management System</h1>
                    <div className='lg:mx-20 md:mx-16 mx-5 mt-10 gap-12'>
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900'>What we do as a building management company in Dhaka</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900'>Building Maintenance and operations</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>Facility Management</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>Security Management</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>Gardening and Landscaping Management</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>Our Steps for COVID-19 as a Building Management Company</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>One of The Best And Affordable Building Management System in Dhaka</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>Why do You Need a Building Management System?</h2>
                        ...
                        <div>
                            <h2 className='font-semibold text-lg text-sky-900 pt-5'>Things to Keep in Mind</h2>
                ...
                <div className='lg:mx-20 md:mx-16 mx-5 my-10 gap-12'>
                    <h2 className='font-semibold text-lg text-sky-900'>Why Choose The Hello Facility for Building Management System?</h2>
