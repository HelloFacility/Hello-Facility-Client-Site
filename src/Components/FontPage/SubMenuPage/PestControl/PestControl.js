    ...
    return (
        <div className='text-justify'>
            ...
            <div className='h-96 mt-1' style={{
                ...
                <div className='lg:flex md:justify-between items-center'>
                    <div className='flex gap-4 items-baseline'>
                        <div>
                            <h1 className='lg:text-4xl md:text-3xl text-2xl font-bold mt-16 lg:ml-28 md:ml-16 ml-5 text-white'>Pest Control</h1>
                        </div>
                        <div>
            ...
            <div className='pt-10'>
                ...
                <h1 className='text-center text-3xl font-bold text-sky-900'>Pest Control</h1>
                <div className='lg:mx-20 md:mx-16 mx-5 mt-10 gap-12'>
                        <h2 className='font-semibold text-lg text-sky-900'>Our Offerings as a Pest Control Service</h2>
                        <h4 className='font-semibold text-base text-sky-900'>Hello Facility is one of the most well-known and dependable Pest Control Services in Dhaka.</h4>
                        ...
                        <h2 className='pt-6 font-semibold text-lg text-sky-900'>Precautions Against COVID-19</h2>
                        ...
                        <h2 className='pt-6 font-semibold text-lg text-sky-900'>Pricing</h2>
                        ...
                        <h2 className='pt-6 font-semibold text-lg text-sky-900'>Why do You Need Professional Pest Control Service in Dhaka?</h2>
                        ...
                        <h2 className='pt-6 font-semibold text-lg text-sky-900'>Things to Keep in Mind</h2>
            ...
            <div className='lg:mx-20 md:mx-16 mx-5 my-10'>
                <h2 className='font-semibold text-lg text-sky-900'>Why Choose The Hello Facility for Pest Control?</h2>
